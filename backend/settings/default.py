...
MAX_TIMEOUT_SECONDS: int = int(os.getenv("MAX_TIMEOUT_SECONDS") or 5 * 60)  # 5 minutes = 300 seconds
NUMBER_OF_ACTIVE_TASK_PER_MANAGER = int(os.getenv("NUMBER_OF_ACTIVE_TASK_PER_MANAGER"))
